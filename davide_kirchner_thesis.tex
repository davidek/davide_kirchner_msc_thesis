...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \noindent\begin{minipage}{.65\textwidth} 
      ...
      \end{minipage} 
    \end{minipage}
    \todo{any strong opinion on colours vs B/W?}
    \vspace{1cm}
...
These results are promising in that they show that software defined networking can achieve performance that are ready for medium-scale deployments, even with the load imposed by a \gls{CCN} router, with data structures that are accessed read/write at the data plane.

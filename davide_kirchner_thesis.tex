...
\todo[inline]{Spend some words on the general principles that (I believe) drove the data structures design: (no dynamically-allocated memory. Minimize stress on cache, as data structures are assumed not to fit in the cache and memory access is the bottleneck)}
